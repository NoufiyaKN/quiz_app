...
function Quiz() {
  ...
  return (
    <>
        <div style={{height: '100vh',border: '1px solid',backgroundImage: 'url("https://c0.wallpaperflare.com/preview/24/729/309/solved-3x3-rubik-s-cube.jpg")',backgroundRepeat: 'no-repeat',backgroundSize: '100% 100%'}}>
        <h1 className='d-flex justify-content-center mt-5'>Quiz App</h1>
